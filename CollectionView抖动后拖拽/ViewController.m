...
@interface ViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,VibrateCollectionViewCellDelegate>
...
//    [cell sizeToFit];
    ...
    cell.headImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"00%@",@12]];
...
- (void)clickdelected:(UIButton *)sender{
    [_collectionArr removeObjectAtIndex:1];
